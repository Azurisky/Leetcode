...
class ExamRoom:
    ...
    ## From https://leetcode.com/problems/exam-room/discuss/139941/Python-O(log-n)-time-for-both-seat()-and-leave()-with-heapq-and-dicts-Detailed-explanation/147981
    def __init__(self, N):
        """
        :type N: int
        """
